...
# Ниже таблица с измерениями разницы радиуса исходного круга и круга с примененным алгоритмом Catmul Clark (модификатором Subdivision Surface)
subdiv = {
    4: [                # Ключ указывает на количество подразделений исходного круга
        (5, 1.66667,),  # Значения указаны для радиуса
        (10, 3.33333,),
        (15, 5,),
    ],
    8: [
