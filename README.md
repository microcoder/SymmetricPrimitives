...
Also the addon allow do calculation of optimal amount segments for setted inaccuracy by diameter when used modifier Subdiv relative to original diameter.
